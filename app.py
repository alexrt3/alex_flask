...
app.config['MYSQL_DB'] = 'alex_flask'
...
def content_based_filtering(product_id):
    ...
    data_cat = data['category']  # get id category (for example shirt)
    ...
    recommend_id = []
    cate_level = ['v_shape', 'polo', 'clean_text', 'design', 'leather', 'color', 'formal', 'converse', 'loafer', 'hook', 'chain']
